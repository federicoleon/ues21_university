...
<html>
	...
	<body>
		...
		<div id="edit-career" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${careerInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${careerInstance}" var="error">
				<li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
				</g:eachError>
			</ul>
			</g:hasErrors>
			<g:form url="[resource:careerInstance, action:'update']" method="PUT" >
				<g:hiddenField name="version" value="${careerInstance?.version}" />
				<fieldset class="form">
